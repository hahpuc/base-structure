...
class EnvironmentService {
  ...
  private loadConfig(): EnvironmentConfig {
    return {
      ...
      appDescription: this.getEnv('VITE_APP_DESCRIPTION', 'Modern React Admin Dashboard'),
      ...
      tokenRefreshThreshold: this.getEnvNumber('VITE_TOKEN_REFRESH_THRESHOLD', 300000),
      ...
      enableDevtools: this.getEnvBoolean('VITE_ENABLE_DEVTOOLS', import.meta.env.DEV),

      // UI Configuration
      defaultLanguage: this.getEnv('VITE_DEFAULT_LANGUAGE', 'en'),
      defaultTheme: this.getEnv('VITE_DEFAULT_THEME', 'light') as 'light' | 'dark',
      ...
      // Development
      logLevel: this.getEnv('VITE_LOG_LEVEL', 'info') as 'debug' | 'info' | 'warn' | 'error',
