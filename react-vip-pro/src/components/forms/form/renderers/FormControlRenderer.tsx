...
interface FormControlRendererProps {
  ...
  // Ant Design Form.Item injects these props
  value?: unknown;
  onChange?: (value: unknown) => void;
}

export const FormControlRenderer: React.FC<FormControlRendererProps> = ({
  control,
  formValues,
  formOptions,
  form,
  ...
  setFileListState,
  loadSelectOptions,
  value, // Injected by Form.Item
  onChange, // Injected by Form.Item
}) => {
    ...
    case "autocomplete": {
      ...
      if (control.parent) {
        ...
        if (selectState) {
          optionsToRender = selectState.options || [];
          isLoadingOptions = selectState.loading || false;
        } else if (!control.usePagination && !Array.isArray(control.options)) {
