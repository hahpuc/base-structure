...
export class S3Service {
  ...
  private async createMultipartUpload(params: CreateMultipartUploadRequest): Promise<string> {
    const response = await this.s3.send(new CreateMultipartUploadCommand(params));
