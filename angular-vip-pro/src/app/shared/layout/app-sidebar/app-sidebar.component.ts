...
export class AppSidebarComponent extends AppBaseComponent implements OnInit, OnDestroy {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2ZM12 6C13.1046 6 14 6.89543 14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6ZM12 12C14.2091 12 16 13.7909 16 16V17C16 17.5523 15.5523 18 15 18H9C8.44772 18 8 17.5523 8 17V16C8 13.7909 9.79086 12 12 12Z" fill="currentColor"></path></svg>`,
          isAccordion: true,
          permissions: "user_manage_read",
          children: [
            {
        ...
        },
        {
          ...
          icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C8.13401 2 5 5.13401 5 9C5 14.25 12 22 12 22C12 22 19 14.25 19 9C19 5.13401 15.866 2 12 2ZM12 11.5C13.3807 11.5 14.5 10.3807 14.5 9C14.5 7.61929 13.3807 6.5 12 6.5C10.6193 6.5 9.5 7.61929 9.5 9C9.5 10.3807 10.6193 11.5 12 11.5Z" fill="currentColor"></path></svg>`,
          isAccordion: true,
  ...
  private async filterMenuByPermissions(): Promise<void> {
    ...
    this.filteredMenuSections = await this.filterMenuSections(
      this.menuSections
    );

    // Legacy support - populate the old arrays if needed
    const mainSection = this.filteredMenuSections.find(
      (section) => section.id === "main"
    );
    const othersSection = this.filteredMenuSections.find(
  ...
  private async filterMenuSections(
  ...
  getMenuSection(sectionId: string): MenuSection | undefined {
    return this.filteredMenuSections.find(
  ...
  addMenuSection(section: MenuSection): void {
    const existingIndex = this.menuSections.findIndex(
      (s) => s.id === section.id
    );
    if (existingIndex >= 0) {
