  ...
  menuSections: MenuSection[] = [
      ...
      items: [
        {
          ...
          label: this.tNs('admin', 'MENU_DASHBOARD'),
          isAccordion: true,
        ...
        },
        {
          ...
          label: this.tNs('admin', 'MENU_PROFILE'),
          path: '/profile',
          permissions: 'user_manage_read',
        },
        {
          label: this.tNs('admin', 'MENU_FORMS'),
          ...
          children: [
            {
              label: this.tNs('admin', 'MENU_FORMS_ELEMENTS'),
              path: '/form-elements',
              icon: '',
              pro: false,
            },
            {
              label: this.tNs('admin', 'MENU_FORMS_ANTD'),
              path: '/form-antd',
              icon: '',
              pro: true,
            },
        ...
        // {
        //   label: this.tNs('admin', 'MENU_TABLES'),
        ...
        //   children: [
        //     {
        //       label: this.tNs('admin', 'MENU_TABLES_BASIC'),
        //       path: '/basic-tables',
        //       icon: '',
        //       pro: false,
        //     },
        ...
        // },
        {
          label: this.tNs('admin', 'MENU_PAGES'),
          ...
          isAccordion: true,
          children: [
            { label: this.tNs('admin', 'MENU_PAGES_BLANK'), path: '/blank', icon: '', pro: false },
            {
              label: this.tNs('admin', 'MENU_PAGES_ERROR'),
              path: '/error-404',
              icon: '',
              pro: false,
            },
      ...
      items: [
        {
          ...
          label: this.tNs('admin', 'MENU_CHARTS'),
          isAccordion: true,
          children: [
            {
              label: this.tNs('admin', 'MENU_CHARTS_LINE'),
              path: '/line-chart',
              icon: '',
              pro: false,
            },
            {
              label: this.tNs('admin', 'MENU_CHARTS_BAR'),
              path: '/bar-chart',
              icon: '',
              pro: false,
            },
        ...
        },
        {
          ...
          label: this.tNs('admin', 'MENU_UI'),
          isAccordion: true,
          children: [
            { label: this.tNs('admin', 'MENU_UI_ALERTS'), path: '/alerts', icon: '', pro: false },
            { label: this.tNs('admin', 'MENU_UI_AVATAR'), path: '/avatars', icon: '', pro: false },
            { label: this.tNs('admin', 'MENU_UI_BADGE'), path: '/badge', icon: '', pro: false },
            { label: this.tNs('admin', 'MENU_UI_BUTTONS'), path: '/buttons', icon: '', pro: false },
            { label: this.tNs('admin', 'MENU_UI_VIDEOS'), path: '/videos', icon: '', pro: false },
            { label: this.tNs('admin', 'MENU_UI_LOADING'), path: '/loading', icon: '', pro: false },
          ],
        },
        {
          ...
          label: this.tNs('auth', 'AUTHENTICATION'),
          isAccordion: true,
          children: [
            { label: this.tNs('auth', 'SIGN_IN'), path: '/signin', icon: '', pro: false },
            { label: this.tNs('auth', 'REGISTER'), path: '/signup', icon: '', pro: false },
          ],
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          label: this.tNs('admin', 'MENU_USER'),
          ...
          children: [
            {
              label: this.tNs('admin', 'MENU_ROLE'),
              path: '/role',
              icon: '',
        ...
        {
          label: this.tNs('admin', 'MENU_ACCOUNT'),
          icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 3.5C7.30558 3.5 3.5 7.30558 3.5 12C3.5 14.1526 4.3002 16.1184 5.61936 17.616C6.17279 15.3096 8.24852 13.5955 10.7246 13.5955H13.2746C15.7509 13.5955 17.8268 15.31 18.38 17.6167C19.6996 16.119 20.5 14.153 20.5 12C20.5 7.30558 16.6944 3.5 12 3.5ZM17.0246 18.8566V18.8455C17.0246 16.7744 15.3457 15.0955 13.2746 15.0955H10.7246C8.65354 15.0955 6.97461 16.7744 6.97461 18.8455V18.856C8.38223 19.8895 10.1198 20.5 12 20.5C13.8798 20.5 15.6171 19.8898 17.0246 18.8566ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12ZM11.9991 7.25C10.8847 7.25 9.98126 8.15342 9.98126 9.26784C9.98126 10.3823 10.8847 11.2857 11.9991 11.2857C13.1135 11.2857 14.0169 10.3823 14.0169 9.26784C14.0169 8.15342 13.1135 7.25 11.9991 7.25ZM8.48126 9.26784C8.48126 7.32499 10.0563 5.75 11.9991 5.75C13.9419 5.75 15.5169 7.32499 15.5169 9.26784C15.5169 11.2107 13.9419 12.7857 11.9991 12.7857C10.0563 12.7857 8.48126 11.2107 8.48126 9.26784Z" fill="currentColor"></path></svg>`,
          isAccordion: true,
          permissions: 'user_manage_read',
          children: [
        ...
        {
          label: this.tNs('admin', 'MENU_LOCATION'),
          ...
          children: [
            {
              label: this.tNs('admin', 'MENU_PROVINCE'),
              path: '/province',
              icon: '',
              permissions: ['province_manage_read'],
            },
            {
              label: this.tNs('admin', 'MENU_WARD'),
              path: '/ward',
              icon: '',
        ...
        {
          label: this.tNs('admin', 'MENU_ARTICLE'),
          ...
          children: [
            {
              label: this.tNs('admin', 'MENU_CATEGORY'),
              path: '/category',
              icon: '',
              permissions: [],
            },
