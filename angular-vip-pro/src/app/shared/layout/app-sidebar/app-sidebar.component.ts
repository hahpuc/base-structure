...
export class AppSidebarComponent extends AppBaseComponent implements OnInit {
  ...
  menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      isAccordion: true,
      children: [
        { label: "Basic Tables", path: "/basic-tables", icon: "", pro: false },
      ],
    },
    {
      label: "Pages",
  ...
  private async filterMenuByPermissions(): Promise<void> {
    ...
    this.filteredOthersItems = await this.filterMenuItems(this.othersItems);
  }
  ...
  private setActiveMenuFromRoute(currentUrl: string) {
    const menuGroups = [
      { items: this.filteredMenuItems, prefix: "main" },
